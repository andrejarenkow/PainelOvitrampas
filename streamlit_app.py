...
if municipio != 'Todos': 
 ...
 with col2:
  ...
  with tab1:
   ...
   map_plotly_fig_calor = ff.create_hexbin_mapbox(data_frame=dados_mapa_geral, lat=-30.456877333125696, lon=-53.01906610604057, nx_hexagon=10, opacity=0.9, color='eggs',
    )
