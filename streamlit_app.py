...
with filtros:
 ...
 with col3:
  semana_epidemiologica = st.selectbox('Selecione a semana epidemiológica', options=sorted(dados[(dados['municipality']==municipio)&dados[(dados['year']==ano)]['week'].unique()))
